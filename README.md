...
3. **Nummernvergabe für Modultypen**
   Jeder Modultyp hat eine eindeutige 8-Bit-Nummer. Die ist in einem I²C-Register auf der Platine fix verdrahtet, damit der Pico sofort weiß, was er vor sich hat. Siehe [`docs/vertrag.md`](docs/vertrag.md), Abschnitt "Modultypen", für die Schwelle, ab der fremde Module Nummern reserviert haben.
